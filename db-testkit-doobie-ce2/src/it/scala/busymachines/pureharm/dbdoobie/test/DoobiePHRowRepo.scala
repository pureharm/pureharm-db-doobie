...
/** Use this also as a rough outline of how you ought to structure your code. Create a trait that extends the Repo[F,
  * MyCaseClass, MyPrimaryKeyType] add whatever new methods/override the default ones you need here.
  *
  * Implement the queries in terms of ConnectionIO similar to DoobiePHRowRepo.DoobiePHRowQueries
  *
  * and the final DAO in IO similar to DoobiePHRowRepo.DoobiePHRowRepoImpl
  *
  * Voila! Bunch of free CRUD! + a lot of helpers to build common queries in the DoobiePHRowRepo.DoobieDoobiePHRowTable
  *
  * @author
...
private[test] object DoobiePHRowRepo {
  ...
  object DoobieDoobiePHRowTable extends TableWithPK[PHRow, SproutPK] {
    ...
    implicit val phJSONColJsonCodec: Codec[PHJSONCol] = derived.codec[PHJSONCol]
  ...
  private object DoobiePHRowQueries
